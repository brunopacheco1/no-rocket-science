      ...
      *******************************************
       ...
       0003-PROCESS-MESSAGE.
           PERFORM 0004-REVERSE-MESSAGE.
           PERFORM 0005-FIX-ERROR.
           PERFORM 0006-READ-DATA.

       0004-REVERSE-MESSAGE.
       ...
       0006-READ-DATA.
           ...
           PERFORM 0007-CONVERT-CURRENT-PORT.
           PERFORM 0008-CONVERT-CURRENT-SEQUENCE.
           PERFORM 0009-CONVERT-CURRENT-CHAR.

       0007-CONVERT-CURRENT-PORT.
